 ...
 *
 * A dozen glyphs is far less code than an icon package, and inlining them means they
 * inherit `currentColor` and cannot arrive late or fail to load. Every one is on a 24-unit
 * grid with a 1.75 stroke, so they sit together at any size.
 */
